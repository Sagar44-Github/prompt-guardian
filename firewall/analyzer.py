...
def analyze_prompt(prompt: str) -> dict:
    ...
    is_multilingual = is_non_english(prompt)
    ...
    logger.info("Analysing prompt hash=%s chars=%d words=%d lang=%s (%.0f%%)",
