...
def threat_feed():
    """
    Return a curated list of known prompt injection threat intelligence entries.
    Data is generated by firewall/threat_intel.py with dynamic timestamps.
    In production this would aggregate live feeds from OWASP, MITRE ATLAS, etc.
    """
    try:
